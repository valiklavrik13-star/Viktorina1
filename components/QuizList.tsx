...
const QuizCard: React.FC<QuizCardProps> = ({ quiz, onStartQuiz, onViewStats, onShareQuiz, onDeleteQuiz, onEditQuiz, onReportQuiz, isMyQuiz, onTagClick }) => {
...
export const QuizList: React.FC<QuizListProps> = ({ quizzes, userId, isMyQuiz, leaderboards, onStartQuiz, onCreateQuiz, onEditQuiz, onStartMovieQuiz, onStartSeriesQuiz, onStartMovieRatingGame, onStartSeriesSeasonRatingGame, onStartDirectorQuiz, onStartYearQuiz, onStartActorQuiz, onStartDescriptionQuiz, onStartSeriesSortingGame, onStartSeriesActorQuiz, onStartSeriesDescriptionQuiz, onViewStats, onDeleteQuiz, onReportQuiz, onShowNotification, isAuthenticated }) => {
  const { t } = useTranslation();
